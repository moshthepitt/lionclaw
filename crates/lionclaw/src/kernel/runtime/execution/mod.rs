...
pub use lionclaw_confinement::{
    ...
    runtime_native_home_mount_source, runtime_skill_mount_target_alias, runtime_state_mount_source,
    ...
    ExecutionOutput, ExecutionPreset, ExecutionRequest, ExecutionSession, InstallPolicy,
    MountAccess, MountSpec, NetworkMode, OciConfinementConfig, OciExecutionBackend,
    RuntimeAuthKind, RuntimeExecutionSession, RuntimeProgramSpec, RuntimeSecretsMount,

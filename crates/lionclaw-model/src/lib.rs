...
pub use event::{
    ...
    RecoveryConfig, RoleInstrumentIdentity, RolePromptTemplate, RoleProofFreshness,
    RoleTurnSuccess, RuntimeConfigurationEvidence, RuntimeInstrumentIdentity,
    SkillInstrumentIdentity, StopBar, TaskCandidateRef, UnavailableReferenceCause, ValidationItem,
